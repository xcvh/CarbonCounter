  ...
  const renderedLinks = links.map((link) => {
    ...
    return (
      ...
      >
        ...
        >
          <Link to={link.path} className={`${activeLink ? "font-bold" : ""}`}>
            {link.label}
          </Link>
        </span>
      </li>
      ...
      <nav className="h-full flex flex-col bg-green-800">
        <div className="p-4 pb-2 flex justify-between items-center">
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-green-900 hover:bg-green-950 text-stone-50"
          >
        ...
        <div className="flex items-center p-3">
          <img
            src="https://ui-avatars.com/api/?name=Jeldo+Meppen&background=fafaf9&color=052e16"
          ...
          >
            <div className="leading-4 whitespace-nowrap">
              <h4 className="font-semibold text-stone-100">Jeldo Meppen</h4>
              <span className="text-xs text-stone-50">hi@jel.do</span>
            </div>
            <MoreVertical size={20} className="flex-shrink-0 text-stone-50" />
          </div>
        </div>
      </nav>
    </aside>
