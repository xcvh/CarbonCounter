...
function Components() {
    ...
    return (
        <div className="prose container mx-auto">
            <h2>Components</h2>
            <p>
                The components we will use to build the questionnaires and
                results pages.
            </p>
            ...
            >
                10 Events erwarten dich auf deiner 5-monatigen Journey und
                sorgen dafür, dass du neue Leute kennenlernst, von den
                Fähigkeiten deiner Mentor:innen lernst und dein Gelerntes nicht
                nur theoretisch, sondern auch praktisch anwenden kannst.
            </Card>
        </div>
    );
}
